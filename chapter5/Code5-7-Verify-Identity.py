...
if __name__ == "__main__":
    claimed_identity = "user"#sys.argv[1]
    cert_file = "usercert.cer"#sys.argv[2]
    issuer_public_key_file = "CAPublicKey.pem"#sys.argv[3]
 ...
 #       challenge_file_object.write(challenge_bytes)
    ...
    with open (challenge_file, "rb") as challenge_object:
        challenge_bytes = challenge_object.read()


    verify_identity(claimed_identity, cert_data, challenge_bytes, response_bytes)

...
def generateKeypair(privKeyFile,pubKeyFile):
    rsa.generate_private_key(2048)


if __name__=="__main__":
    issuer_private_key_file = 'CAPrivateKey.pem' #sys.argv[1]
    certificate_subject = 'user' #sys.argv[2]
    certificate_subject_public_key_file = 'userPublicKey.pem'#sys.argv[3]
    certificate_output_file = 'usercert.cer' #sys.argv[4]
...
#main("PrivatKey.pem","Code5Test","PublicKey.pem","fakecert.cer")
